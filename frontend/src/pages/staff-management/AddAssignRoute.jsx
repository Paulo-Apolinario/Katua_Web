...
import { createAssignment } from '../../services/routeAssignmentService';
import { getAllStaff } from '../../services/staffService';
import { getAllVehicles } from '../../services/vehicleService';
import { getAllRoutes } from '../../services/routeService';
import HeadTags from '../../components/HeadTags';

const AddAssignRoute = () => {
  // Initial form state
  ...
  // Fetch staff, vehicles, and routes for dropdowns
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await createAssignment(dataToSend);
      if (response.success) {
        toast.success(response.message || 'Route assignment created successfully');
        setFormData(initialFormState);
        setErrors({});
      } else {
        toast.error(response.message || 'Failed to create route assignment');
  ...
  return (
    <>
      <HeadTags title="Create Assign" />
      <div className="page-header mb-30 px-2">
        <div className="page-title mb-3">
          <h3 className="fs-30">Create Assign</h3>
        </div>
      ...
      <div className="row justify-content-center mb-5">
        <div className="col-lg-10 col-xl-8">
          <div className="card p-25">
            <h3 className="fw-600 fs-18 mb-4">Basic Assign to Route Information</h3>

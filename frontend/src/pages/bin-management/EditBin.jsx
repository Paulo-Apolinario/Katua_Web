  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [zoneResponse, vehicleResponse, binResponse] = await Promise.all([
          getAllZones(),
          getAllVehicles(),
          getBinById(id),
        ]);
        ...
        if (binResponse?.success) {
          ...
          setFormData({
            ...
            collection_date: formatDateInput(bin.last_collection_date),
            ...
            <form className="form" onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <small className="text-muted d-block mt-1">
                  Envie uma nova foto somente se desejar substituir a imagem atual.
                </small>
                ...
                {(newPhotoPreview || formData.currentPhotoUrl) && (
                  <div className="mt-3">
                    <img
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder="Informe observações sobre localização, acesso, conservação ou restrições."
                  disabled={saving || loading}
                />

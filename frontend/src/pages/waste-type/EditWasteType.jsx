...
import { getWasteTypeById, updateWasteType } from '../../services/wasteTypeService';
...
const EditWasteType = () => {
    ...
    // Fetch waste type data on component mount
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                if (response.success) {
                    ...
                    toast.error('Failed to load waste type');
                }
            } catch (error) {
                toast.error('Error fetching waste type');
    ...
    const handleSubmit = async (e) => {
        ...
        setErrors({});
        try {
            const response = await updateWasteType(id, formData);
            if (response.success) {
                toast.success(response.message || 'update successfully');
                setErrors({});

            } else {
                toast.error(response.message || 'Failed to update waste Type');
            ...
            if (err?.errors) {
                ...
                toast.error(err?.message || 'Failed to update waste type');
            }
        }
    };
    ...
    return (
        <>
          <HeadTags title="Edit Waste Type" />
          <TopProgressBar loading={loading} />
            <div className="page-header mb-30 px-2">
                <div className="page-title mb-3">
                    <h3 className="fs-30">Edit Waste Type</h3>
                </div>
                    ...
                    <div className="breadcrumb-wrap">
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb pb-0 mb-0">
                                ...
                                <li className="breadcrumb-item"><ChevronRight /></li>
                                <li className="breadcrumb-item active" aria-current="page">Edit Waste Type</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div className="row justify-content-center mb-5">
                <div className="col-lg-10 col-xl-8">
                    <div className="card p-25">
                        <h3 className="fw-600 fs-18 mb-4">Edit Waste Type Information</h3>

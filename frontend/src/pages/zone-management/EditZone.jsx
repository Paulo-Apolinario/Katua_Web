...
const EditZone = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Fetch zone data
                const zoneResponse = await getZoneById(id);
                if (zoneResponse.success) {
                    setFormData({
                        zone_name: zoneResponse.data.name || '',
                        area_name: zoneResponse.data.area_names || '',
                        assigned_staff_id: zoneResponse.data.staff_id || '',
                        zone_type: zoneResponse.data.zone_type || '',
                        special_instructions: zoneResponse.data.description || '',
                        status: zoneResponse.data.status || 'active',
                    });
                } else {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await updateZone(id, dataToSend);
            if (response.success) {
           ...
           <TopProgressBar loading={loading} />
            <div className="page-header mb-30 px-2">
                <div className="page-title mb-3">
                    <h3 className="fs-30">Edit Zone</h3>
                </div>
                    ...
                    <div className="breadcrumb-wrap">
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb pb-0 mb-0">
                                ...
                                <li className="breadcrumb-item"><ChevronRight /></li>
                                <li className="breadcrumb-item active" aria-current="page">Edit Zone</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div className="row justify-content-center mb-4">
                <div className="col-lg-10 col-xl-8">
                    <div className="card p-25">
                        <h3 className="fw-600 fs-18 mb-4">Edit Zone Information</h3>

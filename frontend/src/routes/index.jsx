...
import CollectedWasteList from "../pages/waste/CollectedWasteList";
import WasteDestinationForm from "../pages/waste/WasteDestinationForm";
import WasteDestinationHistory from "../pages/waste/WasteDestinationHistory";
...
import GeneratorList from "../pages/generator-management/GeneratorList";
import AddGenerator from "../pages/generator-management/AddGenerator";
import EditGenerator from "../pages/generator-management/EditGenerator";
import GeneratorDocuments from "../pages/generator-management/GeneratorDocuments";
...
import OperationalCalendar from "../pages/operations/OperationalCalendar";
...
import CollectorList from "../pages/staff-management/CollectorList";
        ...
        <Routes>
          ...
          >
            ...
            <Route
              ...
              element={<CollectedWasteList />}
            />

            <Route
              path="collected-waste/:id"
              element={<WasteDestinationForm />}
            />

            <Route
              path="waste-destinations"
              element={<WasteDestinationHistory />}
            />
